...
Technical name: `odomate_hr_documents` · Version `19.0.1.0.1` · Odoo 19 Community
...
This module does not grant any group to any user at install time. Odoo's
`hr` module already grants the administrator **Officer: Manage all
employees** (`hr.group_hr_manager`) natively when it is installed, which is
what makes the **Document Types** menu visible to them.
