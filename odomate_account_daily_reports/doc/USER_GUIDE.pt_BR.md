...
A impressão agrupa os itens em um bloco por dia. As colunas são *Diário, Lançamento, Parceiro, Referência, Rótulo, Débito, Crédito, Diferença* (além de *Moeda* para usuários multimoeda). Cada dia encerra com uma linha **Total do dia**. A linha **Total** do próprio relatório é impressa exatamente uma vez, bem no final do relatório — nunca se repete no meio da impressão, mesmo num relatório de várias páginas — e se destaca das linhas **Total do dia** com um fundo sombreado e uma linha superior mais grossa, para que você as diferencie rapidamente.
...
A impressão traz um bloco por conta, ordenadas pelo código da conta, com as colunas *Data, Diário, Lançamento, Parceiro, Referência, Rótulo, Débito, Crédito, Saldo*. Cada bloco encerra com uma linha **Total da conta**. A linha **Total** do próprio relatório é impressa exatamente uma vez, bem no final do relatório — nunca se repete no meio da impressão, mesmo num relatório de várias páginas — e se destaca das linhas **Total da conta** com um fundo sombreado e uma linha superior mais grossa, para que você as diferencie rapidamente.
