...
Der Ausdruck gruppiert die Zeilen in einen Block je Tag. Die Spalten sind *Journal, Buchung, Partner, Referenz, Bezeichnung, Soll, Haben, Differenz* (sowie *Währung* für Benutzer mit Mehrwährungsfähigkeit). Jeder Tag schließt mit einer **Tagessumme**-Zeile ab. Die eigene **Gesamt**-Zeile des Berichts wird genau einmal gedruckt, ganz am Ende des Berichts — sie wiederholt sich nie mitten im Ausdruck, auch nicht über mehrere Seiten hinweg — und hebt sich von den **Tagessumme**-Zeilen durch einen schattierten Hintergrund und eine dickere obere Linie ab, sodass Sie beide auf einen Blick unterscheiden können.
...
Der Ausdruck enthält je Konto einen Block, sortiert nach Kontonummer, mit den Spalten *Datum, Journal, Buchung, Partner, Referenz, Bezeichnung, Soll, Haben, Saldo*. Jeder Block schließt mit einer **Kontosumme**-Zeile ab. Die eigene **Gesamt**-Zeile des Berichts wird genau einmal gedruckt, ganz am Ende des Berichts — sie wiederholt sich nie mitten im Ausdruck, auch nicht über mehrere Seiten hinweg — und hebt sich von den **Kontosumme**-Zeilen durch einen schattierten Hintergrund und eine dickere obere Linie ab, sodass Sie beide auf einen Blick unterscheiden können.
