...
La impresión agrupa los apuntes en un bloque por día. Las columnas son *Diario, Asiento, Empresa, Referencia, Etiqueta, Debe, Haber, Diferencia* (además de *Moneda* para los usuarios multimoneda). Cada día cierra con una fila **Total del día**. La fila **Total** propia del informe se imprime exactamente una vez, al final del informe — nunca se repite a mitad de la impresión, ni siquiera en un informe de varias páginas — y se distingue de las filas **Total del día** con un fondo sombreado y una línea superior más gruesa, de modo que pueda diferenciarlas de un vistazo.
...
La impresión tiene un bloque por cuenta, ordenadas por código de cuenta, con las columnas *Fecha, Diario, Asiento, Empresa, Referencia, Etiqueta, Debe, Haber, Saldo*. Cada bloque cierra con una fila **Total de la cuenta**. La fila **Total** propia del informe se imprime exactamente una vez, al final del informe — nunca se repite a mitad de la impresión, ni siquiera en un informe de varias páginas — y se distingue de las filas **Total de la cuenta** con un fondo sombreado y una línea superior más gruesa, de modo que pueda diferenciarlas de un vistazo.
