...
Wydruk grupuje pozycje w bloki po jednym na dzień. Kolumny to *Dziennik, Zapis, Kontrahent, Odnośnik, Opis, Winien, Ma, Różnica* (oraz *Waluta* dla użytkowników wielowalutowych). Każdy dzień kończy się wierszem **Razem za dzień**. Własny wiersz **Razem** raportu drukuje się dokładnie raz, na samym końcu raportu — nigdy nie powtarza się w trakcie wydruku, nawet gdy zajmuje on kilka stron — i jest wyróżniony na tle wierszy **Razem za dzień** zacienionym tłem i grubszą górną linią, dzięki czemu można je odróżnić na pierwszy rzut oka.
...
Wydruk zawiera jeden blok na konto, uporządkowane według kodu konta, z kolumnami *Data, Dziennik, Zapis, Kontrahent, Odnośnik, Opis, Winien, Ma, Saldo*. Każdy blok kończy się wierszem **Razem za konto**. Własny wiersz **Razem** raportu drukuje się dokładnie raz, na samym końcu raportu — nigdy nie powtarza się w trakcie wydruku, nawet gdy zajmuje on kilka stron — i jest wyróżniony na tle wierszy **Razem za konto** zacienionym tłem i grubszą górną linią, dzięki czemu można je odróżnić na pierwszy rzut oka.
