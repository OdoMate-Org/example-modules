...
L'impression regroupe les écritures en un bloc par jour. Les colonnes sont *Journal, Écriture, Partenaire, Référence, Libellé, Débit, Crédit, Écart* (plus *Devise* pour les utilisateurs multidevises). Chaque jour se termine par une ligne **Total du jour**. La ligne **Total** propre au rapport s'imprime exactement une fois, tout à la fin du rapport — elle ne se répète jamais en cours d'impression, même sur un rapport de plusieurs pages — et se distingue des lignes **Total du jour** par un fond grisé et un filet supérieur plus épais, afin de pouvoir les différencier d'un coup d'œil.
...
L'impression comporte un bloc par compte, triés par code de compte, avec les colonnes *Date, Journal, Écriture, Partenaire, Référence, Libellé, Débit, Crédit, Solde*. Chaque bloc se termine par une ligne **Total du compte**. La ligne **Total** propre au rapport s'imprime exactement une fois, tout à la fin du rapport — elle ne se répète jamais en cours d'impression, même sur un rapport de plusieurs pages — et se distingue des lignes **Total du compte** par un fond grisé et un filet supérieur plus épais, afin de pouvoir les différencier d'un coup d'œil.
